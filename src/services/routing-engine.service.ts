...
const SKILL_REFINEMENT_PROMPT = [
  ...
  '   - "output_format": Be VERY specific about the exact structure the final model must follow. Include section heading format, list style, spacing, and indentation (e.g., "Gunakan section heading dengan format [NAMA SECTION] pada baris sendiri. Untuk setiap poin gunakan format: N. Judul\\n   - Detail sub-poin. Pisahkan antar section dengan baris kosong. Contoh:\\n\\nPROBLEM STATEMENT\\n1. Poin utama\\n   - Detail 1\\n   - Detail 2\\n\\n2. Poin utama\\n   - Detail 1\\n\\nINFORMASI YANG DIBUTUHKAN\\n1. Poin utama..."). The more specific the output_format, the better the model will follow it.',
